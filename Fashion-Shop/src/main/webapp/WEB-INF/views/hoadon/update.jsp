					...
					<div class="form-holder">
						<div class="form-content">
							<div class="form-items" style="padding: 20px 290px;">
								...
								<sform:form style="padding: 0px 133px; padding-left:16px; padding-bottom: 46px;" modelAttribute="hd"
									action="${rootpath}sua-hd-tc" method="post">
									<div class="col-md-12">
										 <sform:input cssClass="chinhinput" cssStyle="width:150%;" type="number" path="id" readonly="true"/>
									</div>
									<div class="col-md-12">
										 <sform:input type="text" path="nameKH" cssStyle="width:150%;" placeholder="Nhập tên người nhận..." maxlength="50"/>
									</div>
									<div class="col-md-12">
									...
									<div class="col-md-12">
									   <sform:select path="status" cssStyle="width:150%;">
									...
									<div class="col-md-12">
										<sform:input cssClass="chinhinput" cssStyle="width:150%;" type="date" path="ngayban"/>
									</div>		
									<div class="form-button mt-3">
										<button id="submit" type="submit" class="btn btn-primary"
											style="width: 133%;margin-left: 15px;margin-top: 30px;padding: 10px 0px;">Sửa hóa đơn</button>
									</div>
								</sform:form>
							</div>
						</div>
