	...
	<header>
		...
		<div class="left-header w20 float">
			<ul>
				...
				<li><a class="a6" href=""><i class="fa-solid fa-truck"></i>
						Nhập kho</a></li>
		...
		<div class="right-header w80 float">
			<div class="right-headermanh">
				<div class="logo-ok">
					...
					<div class="right-header-taosanpham w33 float">
						<ul>
							<li><a href="${rootpath}insert-san-pham"><i
									class="fa-solid fa-plus"></i> Tạo sản phẩm</a></li>
			...
			<div>
				<table class="table" style="width: 97%;margin: 1em;text-align: center;">
                    <thead>
                        <tr>
