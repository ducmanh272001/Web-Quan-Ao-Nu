					...
					<div class="form-holder">
						<div class="form-content">
							<div class="form-items" style="padding: 20px 290px;">
								...
								<sform:form style="padding: 0px 133px; padding-left:16px; padding-bottom: 46px;" modelAttribute="tintuc"
									...
									<div class="col-md-12">
										 <sform:input type="text" path="title" cssStyle="width:150%;" placeholder="Nhập tiêu đề..." maxlength="50"/>
									</div>
									<div class="col-md-12">
										<sform:input type="text" cssStyle="width:150%;" path="descripe"/>
									</div>
									<div class="col-md-12">
										<sform:input type="text" cssStyle="width:150%;" path="content"  title="${tintuc.content}"/>
									</div>
									<div class="col-md-12">
									   	<sform:input type="text" cssStyle="width:150%;" path="type_tin"/>
									</div>
									<div class="col-md-12">
										 <img style="width: 150%; height: 300px; border-radius: 6px;margin-top: 16px;margin-bottom: 16px;" src="${rootpath}public/img/${tintuc.img}"/>
									</div>
									<div class="col-md-12">
									...
									<div class="form-button mt-3">
										<button id="submit" type="submit" class="btn btn-primary"
											style="width: 133%;margin-left: 15px;margin-top: 30px;padding: 10px 0px;">Sửa tin tức</button>
									</div>
								</sform:form>
							</div>
						</div>
