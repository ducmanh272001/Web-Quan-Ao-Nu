				...
				<div class="row">
					<div class="form-holder">
						<div class="form-content">
							<div class="form-items" style="padding: 20px 250px;">
								<h3>Thêm tin tức</h3>
								...
								<sform:form style="padding: 0px 133px; padding-left:16px; padding-bottom: 46px;" modelAttribute="tintuc"
									...
									<div class="col-md-12">
										<sform:input type="text" placeholder="Nhập mô tả..." cssStyle="width:150%;" path="descripe"/>
									</div>
									<div class="col-md-12">
										<sform:input type="text" placeholder="Nhập nội dung..." cssStyle="width:150%;" path="content"  title="${tintuc.content}"/>
									</div>
									<div class="col-md-12">
									   	<sform:input type="text" placeholder="Nhập thuộc tính tin..." cssStyle="width:150%;" path="type_tin"/>
									</div>
									...
									<div class="form-button mt-3">
										<button id="submit" type="submit" class="btn btn-primary"
											style="width: 136%;margin-left: 15px;margin-top: 30px;padding: 10px 0px;">Thêm tin tức</button>
									</div>
								</sform:form>
							</div>
						</div>
