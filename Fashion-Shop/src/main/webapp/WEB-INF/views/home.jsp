                                            ...
                                            <div class="hot-product-img-one sanphamoi">
                                                <div class="thump">
                                                    ...
                                                    <div class="image-zoom">
                                                        <img src="${rootpath}public/img/${l.img}" alt="">
                                                        <img class="zooom-product" src="${rootpath}public/img/${l.img}" alt="">
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                            <div class="hot-product-img-one sanphamoi">
                                                <div class="thump">
                                                    ...
                                                    <div class="image-zoom">
                                                        <img src="${rootpath}public/img/${ld.img}" alt="">
                                                        <img class="zooom-product" src="${rootpath}public/img/${ld.img}" alt="">
                                                    </div>
                                                    <div class="icon-hot-product">
                                                        <a href=""><i class="fa-regular fa-heart"></i></a>
                                                        <a class="open-quick" href=""><i
