                    ...
                    <div class="products-cart-content">
                        <div class="products-cart">
                            <div class="products-cart-img">
                                <a href=""><img src="${rootpath}public/${rootpath}public/img/A280-Ao-kieu-xep-ta-phoi-nut-Den.jpg" alt=""></a>
                            </div>
                            <div class="products-cart-content">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="product-single-one-img">
                        <img src="${rootpath}public/img/${sp.img}" class="x-zoom" xoriginal="${rootpath}public/img/${sp.img}">
                    </div>
                    <div class="product-img-zoom">
                        <div class="product-img-zoom-one"><a href="${rootpath}public/img/${sp.img}"><img class="xzoom-smale" src="${rootpath}public/img/${sp.img}"></a></div>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="product-single-one-text">
                        <div class="modal-product-single-one">
                            ...
                            <div class="review-star">
                                ...
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                                <span>(2 Customer Review, <b>View: ${sp.sp_view}</b>)</span>
                            </div>
                            <h4>
                                ${sp.price_new}
                                <del>${sp.price_old}</del>
                            </h4>
                             <b>Mô tả sản phẩm:</b><p>${sp.descripe}</p>
                           ...
                           <form action="${rootpath}thanh-toan-gio" method="get">
                            ...
                            <div class="color">
                                 ...
                                 <c:forEach items="${lms}" var="lss">
                                   <c:if test="${lss.id == 1}">
                                        <label for="color-red">
                                        <input class="input-red" name="gender" type="radio" checked value="${lss.name}">
                                        <span class="product-cl-red" style="background-color: pink;"></span>
                                    </label>
                                   </c:if>
                                   <c:if test="${lss.id == 2}">
                                        <label for="color-red">
                                        <input class="input-red" name="gender" type="radio" value="${lss.name}">
                                        <span class="product-cl-red" style="background-color: gray;"></span>
                                    </label>
                                   </c:if>
                                    <c:if test="${lss.id == 3}">
                                        <label for="color-red">
                                        <input class="input-red" name="gender" type="radio" value="${lss.name}">
                                        <span class="product-cl-red" style="background-color: yellow;"></span>
                                    </label>
                                   </c:if>
                                 </c:forEach>
                              </div>
                            ...
                            <div class="link-product-area">
                                ...
                                <div class="idsanpham">
                            <input style="display: none;" type="number" value="${sp.id}" name="idsp">
                                </div>
                                <span style="color: red;text-decoration: underline;">${nl}</span>
                                <br>
                                <input class="nutbutton" type="submit" value="ADD TO CART">
                            </div>
                          </form>
                        </div>
                    </div>
            ...
            <div class="row">
             ...
             <div class="product-two">
                <div class="row">
                    ...
                    <c:forEach items="${lspmt}" var="spct">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="hot-product-img-one item">
                                <div class="thump">
                                    <span> Mã: <b>${spct.id}</b></span>
                                    <div class="image-zoom">
                                        <img src="${rootpath}public/img/${spct.img}" alt="">
                                        <img class="zooom-product" src="${rootpath}public/img/${spct.img}" alt="">
                                    </div>
