				...
				<div class="row">
					<div class="form-holder">
						<div class="form-content">
							<div class="form-items" style="padding: 20px 290px;">
								...
								<sform:form style="padding: 0px 133px; padding-left:16px; padding-bottom: 46px;" modelAttribute="kh"
									action="${rootpath}udate-kh-tc" method="post">
									<div class="col-md-12">
										 <sform:input cssClass="chinhinput" cssStyle="width:150%;" type="number" path="id" readonly="true"/>
									</div>
									<div class="col-md-12">
										 <sform:input type="text" path="name" cssStyle="width:150%;" placeholder="Nhập tên khách hàng..." maxlength="50"/>
									</div>
									<div class="col-md-12" style="padding-bottom: 16px;display: none;">
										<sform:input type="text" cssStyle="width:150%;" path="account"/>
									</div>
									<div class="col-md-12" style="display: none;">
										<sform:input type="text" cssStyle="width:150%;" path="passwword"/>
									</div>
									<div class="col-md-12">
										<sform:input cssClass="chinhinput" cssStyle="width:150%;"  type="text" path="address"/>
									</div>
									<div class="col-md-12">
										<sform:input cssClass="chinhinput" cssStyle="width:150%;" type="text" path="call"/>
									</div>
									<div class="col-md-12">
										<sform:input cssClass="chinhinput" cssStyle="width:150%;" type="text" path="email"/>
									</div>
									<div class="col-md-12">
										<sform:input cssClass="chinhinput" cssStyle="width:150%;" type="date" path="birthday"/>
									</div>
									...
									<div class="col-md-12" style="padding-top: 16px">
										<sform:radiobutton path="status" value="1"/>Hoạt động
                                        <sform:radiobutton path="status" value="0"/>Không hoạt động
			 						</div>			
