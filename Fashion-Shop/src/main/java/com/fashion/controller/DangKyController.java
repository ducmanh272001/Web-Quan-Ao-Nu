...
public class DangKyController {
	...
	public String dangKySuccess(@Valid @ModelAttribute(value = "luser") User userok,@RequestParam(value = "laipass")String laipass,BindingResult result, Model model) {
		if(result.hasErrors()) {
			return "login/sign-up";
		}
