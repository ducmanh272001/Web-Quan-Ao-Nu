...
public class AoNuController {
	...
	public String aoNuA280(@PathVariable(value = "idla")int idok, HttpServletRequest request,Model model) {
		...
		String URL = "http://localhost:8080/Fashion-Shop-Api/rest/San-pham/search-id/"+idok;
		...
		Type typeOfT = new TypeToken<List<Kichco>>(){}.getType();
		...
		Type typems = new TypeToken<List<Mausac>>(){}.getType();
